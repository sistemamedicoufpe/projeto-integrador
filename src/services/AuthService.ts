...
export class AuthService {
  private static readonly USERS_KEY = 'usuarios';
  private static readonly CURRENT_USER_KEY = 'usuario_atual';

  static cadastrarUsuario(dados: UsuarioCadastro): { sucesso: boolean; mensagem: string; usuario?: Usuario } {
  ...
  static login(credenciais: UsuarioLogin): { sucesso: boolean; mensagem: string; usuario?: Usuario } {
    const usuarios = this.obterTodosUsuarios();
  ...
  static obterUsuarioAtual(): Usuario | null {
    return StorageService.get<Usuario>(this.CURRENT_USER_KEY);
  }
  ...
  static atualizarPerfil(dados: Partial<Usuario>): { sucesso: boolean; mensagem: string } {
  ...
  private static obterTodosUsuarios(): Usuario[] {
    return StorageService.get<Usuario[]>(this.USERS_KEY) || [];
  }
  ...
  static atualizarUsuario(id: string, dados: Partial<Usuario>): { sucesso: boolean; mensagem: string } {
    const usuarios = this.obterTodosUsuarios();
  ...
  static excluirUsuario(id: string): { sucesso: boolean; mensagem: string } {
    const usuarios = this.obterTodosUsuarios();
  ...
  static resetarSenha(id: string, novaSenha: string): { sucesso: boolean; mensagem: string } {
