...
export class PacientesPage {
    ...
    static renderPacientes(pacientes) {
    ...
    static init() {
        ...
        window.viewPaciente = (id) => this.viewPaciente(id);
        window.editPaciente = (id) => this.editPaciente(id);
        window.togglePacienteStatus = (id, ativar) => this.toggleStatus(id, ativar);
        window.deletePaciente = (id) => this.deletePaciente(id);
    ...
    static salvarPaciente() {
        ...
        const cpf = document.getElementById('paciente-cpf').value.replace(/\D/g, '');
        ...
        const dados = {
            ...
            dataNascimento: new Date(document.getElementById('paciente-data-nascimento').value),
            cpf: cpf,
            rg: document.getElementById('paciente-rg').value,
            telefone: document.getElementById('paciente-telefone').value.replace(/\D/g, ''),
            email: document.getElementById('paciente-email').value,
            endereco: {
                rua: document.getElementById('paciente-rua').value,
                ...
                cep: document.getElementById('paciente-cep').value.replace(/\D/g, '')
            },
            convenio: document.getElementById('paciente-convenio').value,
            numeroConvenio: document.getElementById('paciente-numero-convenio').value,
            contatoEmergencia: {
                nome: document.getElementById('paciente-emergencia-nome').value,
                telefone: document.getElementById('paciente-emergencia-telefone').value.replace(/\D/g, ''),
                parentesco: document.getElementById('paciente-emergencia-parentesco').value
            },
    ...
    static editPaciente(id) {
        ...
        document.getElementById('paciente-data-nascimento').value = Helpers.dataParaInput(paciente.dataNascimento);
        document.getElementById('paciente-cpf').value = Helpers.formatarCPF(paciente.cpf);
        document.getElementById('paciente-rg').value = paciente.rg || '';
        document.getElementById('paciente-telefone').value = Helpers.formatarTelefone(paciente.telefone);
        document.getElementById('paciente-email').value = paciente.email || '';
        document.getElementById('paciente-rua').value = paciente.endereco.rua;
        document.getElementById('paciente-numero').value = paciente.endereco.numero;
        document.getElementById('paciente-complemento').value = paciente.endereco.complemento || '';
        document.getElementById('paciente-bairro').value = paciente.endereco.bairro;
        document.getElementById('paciente-cidade').value = paciente.endereco.cidade;
        document.getElementById('paciente-estado').value = paciente.endereco.estado;
        document.getElementById('paciente-cep').value = Helpers.formatarCEP(paciente.endereco.cep);
        document.getElementById('paciente-convenio').value = paciente.convenio || '';
        document.getElementById('paciente-numero-convenio').value = paciente.numeroConvenio || '';
        document.getElementById('paciente-emergencia-nome').value = paciente.contatoEmergencia.nome;
        document.getElementById('paciente-emergencia-telefone').value = Helpers.formatarTelefone(paciente.contatoEmergencia.telefone);
        document.getElementById('paciente-emergencia-parentesco').value = paciente.contatoEmergencia.parentesco;
    ...
    static deletePaciente(id) {
        ...
        if (!paciente)
            return;
        const confirmacao = Helpers.confirmar(`ATENÇÃO: Você está prestes a EXCLUIR PERMANENTEMENTE o paciente:\n\n` +
    ...
    static obterPacientesPorFiltro(filtro) {
...
PacientesPage.editingId = null;
PacientesPage.FILTRO_KEY = 'pacientes_filtro_status';
//# sourceMappingURL=PacientesPage.js.map