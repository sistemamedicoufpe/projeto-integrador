...
import { AvaliacaoService } from './AvaliacaoService.js';
export class RelatorioService {
    ...
    static gerarRelatorioGeral() {
      ...
      <div class="relatorio">
        ...
        <div class="estatisticas">
          ...
          <ul>
            ${Object.entries(estatisticasAvaliacoes.porTipo).map(([tipo, qtd]) => `<li><strong>${tipo}:</strong> ${qtd}</li>`).join('')}
          </ul>
        </div>
    ...
    static downloadRelatorio(html, nomeArquivo) {
        ...
        for (let i = 1; i <= totalPages; i++) {
            ...
            doc.text(`Gerado em ${this.formatarDataHora(new Date())} - Página ${i} de ${totalPages}`, pageWidth / 2, pageHeight - 10, { align: 'center' });
        }
        // Salvar PDF
